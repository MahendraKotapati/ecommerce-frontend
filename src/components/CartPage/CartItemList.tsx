...
export const CartItemList = () => {
    ...
    const [cartItems, setCartItems] = useState(DATA_CART.items);
                        ...
                        <div className="flex gap-4 w-2xl">
                            ...
                            <div className="flex-1 flex flex-col">
                                <div className="flex justify-between"> 
                                    ...
                                    <RiDeleteBinFill className="h-6 w-6 text-red-500" />
                                </div>
                                <div className="flex justify-between mt-2">
                                    <Title> {"$" + cartItem.price} </Title>
                                    <QuantityButton quantity={cartItem.quantity} setQuantity={() => {}} customStyles={"gap-6 grow-0"} />
                                </div>
                            </div>
                        </div>
